    ...
    <>
      <div className="flex flex-col max-w-3xl p-6 space-y-4 sm:p-10 dark:bg-gray-50 dark:text-gray-800">
              ...
              <div className="flex flex-col justify-between w-full pb-4">
                <div className="flex justify-between w-full pb-2 space-x-2">
                  ...
                  <div className="text-right">
                    <p className="text-lg font-semibold">Kes 59.99</p>
            ...
            <div className="flex w-full space-x-2 sm:space-x-4">
              ...
              <div className="flex flex-col justify-between w-full pb-4">
                <div className="flex justify-between w-full pb-2 space-x-2">
                  ...
                  <div className="text-right">
                    <p className="text-lg font-semibold">Kes 99.95</p>
                    <p className="text-sm line-through dark:text-gray-400">
                      Kes 150
                    </p>
                  </div>
            ...
            <div className="flex w-full space-x-2 sm:space-x-4">
              ...
              <div className="flex flex-col justify-between w-full pb-4">
                <div className="flex justify-between w-full pb-2 space-x-2">
                  ...
                  <div className="text-right">
                    <p className="text-lg font-semibold" Kes>
                      8.99
                    </p>
                    <p className="text-sm line-through dark:text-gray-400">
                      Kes 15.99
        ...
        <div className="space-y-1 text-right">
          <p>
            Total amount:
            <span className="font-semibold" Kes>
              357{" "}
            </span>
          </p>
        ...
        <div className="flex justify-end space-x-4">
          <Link to={"/"}
            type="button"
            className="px-6 py-2 border rounded-md border-(--darkBrownish) text-(--carkBrownish)"
          >
            Back
          ...
          <button
            type="button"
            className="px-6 py-2 border rounded-md dark:bg-(--darkBrownish) dark:text-(--creamish)"
          >
